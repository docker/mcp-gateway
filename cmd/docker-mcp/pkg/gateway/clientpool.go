...
import (
	...
	"github.com/docker/mcp-gateway/cmd/docker-mcp/pkg/eval"
	"github.com/docker/mcp-gateway/cmd/docker-mcp/pkg/gateway/proxies"
	mcpclient "github.com/docker/mcp-gateway/cmd/docker-mcp/pkg/mcp"
)
