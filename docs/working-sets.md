...
docker mcp catalog-next create my-catalog --from-working-set my-working-set

# Create with a custom name
docker mcp catalog-next create my-catalog --from-working-set my-working-set --name "My Catalog"
