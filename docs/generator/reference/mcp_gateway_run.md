...
| `--catalog`                 | `stringSlice` |                  | Paths to docker catalogs (absolute or relative to ~/.docker/mcp/catalogs/)                                                                    |
| `--config`                  | `stringSlice` |                  | Paths to the config files (absolute or relative to ~/.docker/mcp/)                                                                            |
...
| `--registry`                | `stringSlice` |                  | Paths to the registry files (absolute or relative to ~/.docker/mcp/)                                                                          |
...
| `--tools-config`            | `stringSlice` |                  | Paths to the tools files (absolute or relative to ~/.docker/mcp/)                                                                             |
