...
| `--telemetry-mcp-server-host` | `string`      |                     | Host of custom telemetry MCP server (if empty, starts built-in server)                                                                        |
| `--telemetry-mcp-server-port` | `int`         | `0`                 | Port of custom telemetry MCP server                                                                                                           |
